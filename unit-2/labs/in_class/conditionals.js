...
if(num % 2 == 0) {
    ...
    let dividend = num / oneHundred;
    console.log(`100 divided by ${num} is ${dividend}`);
} else if (num % 2 == 1) {
    console.log(`An Odd Number: ${num}`);
    let subtract = oneHundred - num;
    console.log(`100 minus ${num} is ${subtract}`);
}
...
let reqBakeTimeInMins = 5;
let actBakeTimeInMins = 6;
