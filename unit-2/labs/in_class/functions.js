...
/*
    ...
    1. Keyword
    2. Name of the function and paranthesis for the parameter
...
hello(); //Expression variable ename is required to run function
//hey(); doesn't run
...
// Given the array, create a function that lists out the values indeividually 
...
2. Using string interpolation, we can refer to the parameter gave to the funtion.
3. This is where we define what that parameters' value will be.
*/
...
//? same function aboce as concise body
...
/* 
    ...
    - Helps allocating space in memory for anonymous function
...
let theCheck = function tipCalc(total, percent, tax) {
    total += (total * (tax * 0.01));
    total += (total * (percent * 0.01));
    return total;
}

console.log(theCheck(60, 10, 10));