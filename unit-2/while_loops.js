/*
    ...
    - The main purpose of while loops are when the iteration is uncertain.
*/


let city = [
    'building', 'building', 'light pole', 'bridge', 'light pole', 'tree', 'empty street'
];
...
villian.hp <= 0 ?
    ...
    console.log(`${villian.baddie} had taken down Spider-Man!`);