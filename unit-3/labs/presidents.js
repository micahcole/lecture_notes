...
console.log(numOfPres);

//! Challenge 2:
//Create a list of all presedents that are alive.

let alive = presidents.filter(presidents => presidents.passed == undefined);
console.log(alive);
...
let dead = presidents.filter(presidents => presidents.passed != undefined);
console.log(dead);